...
| --- | --- | --- | --- | --- |
| Unit 0 | 프로젝트 스캐폴딩과 개발 도구 구성 | P0 | 없음 | TODO |
| Unit 1 | 도메인 모델, 상수, mock 데이터, 계산 로직 SSOT 구축 | P0 | Unit 0 | TODO |
| Unit 2 | 공통 앱 쉘, 라우팅, 테마, 레이아웃 기반 구축 | P0 | Unit 0, Unit 1 | TODO |
